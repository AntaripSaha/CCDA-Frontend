...
@section('main')
     ...
     <div class="main-content">
        ...
        <div class="container-fluid p-0">
            ...
            <div class="rev_slider_wrapper">
                <div class="rev_slider rev_slider_default" data-version="5.0">
                    ...
                    <!-- SLIDE 1 -->
                    <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x844" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('images/download/5.jpg')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE 2 -->
                    <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x844" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('images/download/3.png')}}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE 3 -->
                    <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x844" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('images/download/2.png')}}"  alt=""  data-bgposition="top 30%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                        <!-- LAYERS -->
        ...
        {{-- <!-- Section: home-boxes -->
        <section class="layer-overlay overlay-theme-colored-8" data-bg-img="http://placehold.it/1920x1280">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="img-hover-border mt-sm-40">
                        <img class="img-fullwidth" src="http://placehold.it/275x335" alt="">
                    </div>
                    </div>
                    <div class="col-md-6 col-sm-6 pl-0 pr-0">
                    <div class="img-hover-border mt-sm-30">
                        <img class="img-fullwidth" src="http://placehold.it/280x156" alt="">
                    </div>
                    <div class="img-hover-border mt-15 mt-sm-30">
                        <img class="img-fullwidth" src="http://placehold.it/325x176" alt="">
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="about-details">
                    <h2 class="font-36 mt-0"> Welcome to <span class="text-theme-colored">CCDA</span></h2>
                    <p>Update Centre for Community Development Assistance (CCDA), a pro-poor, non-political and non-profit development organization, was established in 1990 at a remote Bangladesh village named Adampur at eliotgonj south uinion
                        under Daudkndi Upazila (sub-district) of Comilla district. Today, at the end of December 2021, CCDA is implementing several projects by engaging more than 666 staff to provide services to some 12-15 lac beneficiaries with around 136,337 members in 45 upazilas...</p>
        ...
        <!-- Divider: Funfact -->
        <section class="divider parallax layer-overlay overlay-dark-9" data-bg-img="http://placehold.it/1920x1280" data-parallax-ratio="0.7">
        ...
        <div class="container">
            ...
            <div class="row multi-row-clearfix">
                ...
                <div class="team-member clearfix">
                    ...
                    <img alt="" src="http://placehold.it/360x360" class="img-fullwidth">
                    <div class="overlay">
                        <div class="content">
        ...
        <section class="divider parallax layer-overlay overlay-dark-9" data-stellar-background-ratio="0.2"  data-bg-img="http://placehold.it/1920x1280">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <img class="hidden-sm hidden-xs" src="http://placehold.it/410x504" alt="">
                </div>
            </div>
            </div>
        </div>
        ...
        <section class="divider parallax layer-overlay overlay-dark-9" data-bg-img="http://placehold.it/1920x844" data-parallax-ratio="0.7">
